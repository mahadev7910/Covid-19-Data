...
class regForm extends JFrame implements ActionListener {
	...
	JTextField t7,t8,t9,t10,t11,t12,t13,t14,t15;
	JLabel jl1,jl2,jl3,jl4,jl5,jl6,jl7;
	JLabel jl8,jl9,jl10,jl11,jl12,jl13,jl14,jl15;
	JComboBox cg,ce,cf;
	...
	public regForm(){
		...
		p1.add(cg);   p1.add(t5);   p1.add(t6);
		p1.add(jl7);  p1.add(jl8);  p1.add(jl9);
		p1.add(t7);   p1.add(t8);   p1.add(t9);
		p1.add(jl10); p1.add(jl11); p1.add(jl12);
		p1.add(t10);  p1.add(t11);  p1.add(t12);
		p1.add(jl13); p1.add(jl14); p1.add(jl15);
		p1.add(ce);   p1.add(cf);   p1.add(t15);

		// Submit Button :
		JButton submit = new JButton("submit",new ImageIcon("images/submit.png"));
		submit.setPreferredSize(new Dimension(110,27));
		submit.setBorder(new LineBorder(Color.BLACK,1));

		// Cancel Button :
		JButton cancel = new JButton("Cancel",new ImageIcon("images/cancel.png"));
		...
		ImageIcon img = new ImageIcon("images/download (2).jpg");
